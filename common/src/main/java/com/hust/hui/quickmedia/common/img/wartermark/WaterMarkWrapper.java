package com.hust.hui.quickmedia.common.img.wartermark;
...
public class WaterMarkWrapper {
    ...
    public static class Builder {
        ...
        public Builder setSource(String source) throws IOException {
            return setSource(ImageUtil.getImageByPath(source));
        }
        ...
        public Builder setWaterLogo(String waterLogo) throws IOException {
            return setWaterLogo(ImageUtil.getImageByPath(waterLogo));
        }
        ...
        public Builder setWaterInfo(String waterInfo) {
            this.waterInfo = Arrays.asList(StringUtils.split(waterInfo, "\n"));
            return this;
        }
        ...
        private BufferedImage buildBasicWater() {
            ...
            if (style != WaterMarkOptions.WaterStyle.FILL_BG
                    && rotate != 0) {
                tmpWater = ImageUtil.rotateImg(tmpWater, rotate);
            }
        ...
        private BufferedImage buildBgWater() {
            ...
            this.tmpWater = ImageUtil.rotateImg(water, rotate);
            return tmpWater;
        }
