...
public class ImgCreateController {
    ...
    public ResponseWrapper<ImgCreateResponse> create(HttpServletRequest httpServletRequest, ImgCreateRequest imgCreateRequest) throws IOException {
        ImgCreateWrapper.Builder build = ImgCreateWrapper.build()
                .setImgW(imgCreateRequest.getW())
        ...
        res.setImg(DomUtil.toDomSrc(ans, DomUtil.DomType.IMG_PNG));
