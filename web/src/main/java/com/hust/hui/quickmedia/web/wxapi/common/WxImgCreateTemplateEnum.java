 ...
 */
public enum WxImgCreateTemplateEnum {
    /**
     * 水平文字，上下布局， 左对齐，图片放最后
     */
    ...
    WxImgCreateTemplateEnum(String id, ImgCreateOptions.DrawStyle drawStyle,
    ...
    private static Map<String, WxImgCreateTemplateEnum> map = new HashMap<>();
    static {
        for(WxImgCreateTemplateEnum e: values()) {
            map.put(e.id, e);
        }
    }

    public static WxImgCreateTemplateEnum getEnum(String id) {
        return map.get(id);
    }
