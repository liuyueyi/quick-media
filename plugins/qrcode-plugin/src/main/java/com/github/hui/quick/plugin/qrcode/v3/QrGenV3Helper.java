 ...
 */
public class QrGenV3Helper {
    private static Logger log = LoggerFactory.getLogger(QrGenV3Helper.class);
     ...
     */
    public static BitMatrixEx encode(QrOptions qrCodeConfig) throws WriterException {
        ...
        clearLogo(bitMatrixEx, qrCodeConfig.getLogo());
        return bitMatrixEx;
    }

    private static void clearLogo(BitMatrixEx bitMatrixEx, LogoOptions logoOptions) {
        if (logoOptions == null || logoOptions.isClearArea()) {
            return;
        }
