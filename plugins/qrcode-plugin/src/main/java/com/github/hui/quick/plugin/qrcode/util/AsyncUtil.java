...
public class AsyncUtil {
    private static final ThreadFactory THREAD_FACTORY = new ThreadFactory() {
        ...
        public Thread newThread(Runnable r) {
            ...
            thread.setName("quick-media-" + this.threadNumber.getAndIncrement());
            return thread;
        }
    };
    ...
    public static void initExecutorService(int core, int max) {
        ...
        executorService = new ThreadPoolExecutor(core, max, 0, TimeUnit.SECONDS,
                new SynchronousQueue<Runnable>(), THREAD_FACTORY, new ThreadPoolExecutor.CallerRunsPolicy());
