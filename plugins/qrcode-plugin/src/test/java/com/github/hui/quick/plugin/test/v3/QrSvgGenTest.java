...
public class QrSvgGenTest {
    ...
    @Test
    public void baseTestAsFile() throws Exception {
        boolean ans = QrCodeGenV3.of(msg)
                .asFile(prefix + "/basic.svg");
        System.out.println(ans);
    }

    @Test
    public void basicConfigAsFile() throws Exception {
        boolean ans = QrCodeGenV3.of(msg)
                .setSize(300)
...
//                .setPicType(PicTypeEnum.JPG)
    ...
    private Map<String, List<String>> birdSvgSymbols = new HashMap<>();

    {
        birdSvgSymbols.put("1x1", Arrays.asList(
        ...
        birdSvgSymbols.put("1x2", Arrays.asList(
        ...
        birdSvgSymbols.put("2x1", Arrays.asList(
        ...
        birdSvgSymbols.put("2x2", Arrays.asList(
        ...
        birdSvgSymbols.put("defs", Arrays.asList(
                "<defs>\n" +
                        "        <g id=\"def_HA62\">\n" +
        ...
        birdSvgSymbols.put("detect", Arrays.asList(
    ...
    public void symbolBird() throws Exception {
        boolean svg = QrCodeGenV3.of(msg)
                .setW(500)
                .setQrType(QrType.SVG)
                .newDrawOptions()
                ...
                .complete()
                .newDetectOptions()
                .setLt(new QrResource().setSvg(birdSvgSymbols.get("detect").get(0)))
                .setRt(new QrResource().setSvg(birdSvgSymbols.get("detect").get(1)))
                .setLd(new QrResource().setSvg(birdSvgSymbols.get("detect").get(2)))
                .complete()
                .build()
