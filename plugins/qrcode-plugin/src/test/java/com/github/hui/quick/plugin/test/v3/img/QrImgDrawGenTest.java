...
public class QrImgDrawGenTest extends BasicGenTest {
    ...
    public void imgTxtGeo() throws Exception {
        boolean ans = QrCodeGenV3.of(msg).setSize(500)
                ...
                .addResource(new QrResource().setDrawStyle(DrawStyle.TXT).setTxtMode(TxtMode.ORDER).setText("欢迎关注一灰灰微信公众号").setDrawColor(Color.BLUE), 12)
                .build()
                .createSource(2, 2).addResource(new QrResource("love/01.png"), 4)
                .build()
                .createSource(3, 3).addResource(new QrResource().setDrawStyle(DrawStyle.MINI_RECT), 2)
                .build()
                .over()
                .complete()
                .setDetect(new QrResource().setImg("love/01.png"))
